...
def get_openai_summary(text: str, question: str):
    response = openai.ChatCompletion.create(
        model="gpt-3.5-turbo",
        messages=[{"role": "system", "content": "Describe a webpage from the economic club website in 10 words or less. This webpage may or may not contain a some information relevant to a question that the user asked. Describe the webpage regardless. " +
